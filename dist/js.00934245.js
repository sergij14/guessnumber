...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"js.js":[function(require,module,exports) {
"use strict";
...
document.querySelector(".check-form").addEventListener("submit", function (e) {
  e.preventDefault();
  var guess = Number(document.querySelector(".guess").value); // no input
  ...
  if (!guess) {
    document.querySelector(".message").textContent = "No Number ! ";
      ...
      document.querySelector(".highscore").textContent = highScore; // wrong number
    } else if (guess !== secretNumber) {
      if (score > 1) {
...
},{"core-js/stable":"node_modules/core-js/stable/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
